...
__all__ = [
    'IUIAutomationRangeValuePattern', 'UIA_CultureAttributeId',
    'UIA_SpreadsheetItemPatternId',
    'UIA_StrikethroughStyleAttributeId', 'UIA_MarginTopAttributeId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_SpreadsheetPatternId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_ItemTypePropertyId', 'StyleId_Custom', 'TextUnit_Paragraph',
    'UIA_IsPeripheralPropertyId', 'UIA_LayoutInvalidatedEventId',
    'UIA_WindowCanMinimizePropertyId', 'UIA_OrientationPropertyId',
    'TreeScope_Descendants', 'AnnotationType_Author',
    'UIA_DragIsGrabbedPropertyId', 'UIA_ImageControlTypeId',
    'TextUnit_Character', 'UiaChangeInfo',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_MenuModeStartEventId', 'UIA_LocalizedControlTypePropertyId',
    'UIA_CustomNavigationPatternId', 'IUIAutomationElement9',
    'UIA_OverlineColorAttributeId',
    'UIA_IsItemContainerPatternAvailablePropertyId', 'TreeScope',
    'UIA_OverlineStyleAttributeId', 'TextEditChangeType_AutoCorrect',
    'StyleId_Subtitle', 'UIA_ClassNamePropertyId', 'HeadingLevel7',
    ...
    'IUIAutomationElement2', 'UIA_FormLandmarkTypeId',
    'UIA_IsValuePatternAvailablePropertyId',
    'IUIAutomationScrollItemPattern', 'ZoomUnit_LargeIncrement',
    'UIA_IsEnabledPropertyId', 'SupportedTextSelection_Multiple',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'AnnotationType_Mathematics', 'TextEditChangeType_Composition',
    'IUIAutomationSelectionItemPattern',
    'SynchronizedInputType_LeftMouseUp', 'StyleId_Emphasis',
    'UIA_FillTypePropertyId', 'ProviderOptions_HasNativeIAccessible',
    'UIA_SizePropertyId', 'NotificationProcessing_MostRecent',
    'UIA_SeparatorControlTypeId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_MarginTrailingAttributeId', 'AutomationElementMode_Full',
    'UIA_DragDropEffectsPropertyId', 'UIA_AriaPropertiesPropertyId',
    'ProviderOptions_NonClientAreaProvider',
    'IUIAutomationItemContainerPattern', 'UIA_OutlineColorPropertyId',
    'StructureChangeType', 'UIA_SynchronizedInputPatternId',
    'UIA_MenuBarControlTypeId', 'ProviderOptions',
    'ScrollAmount_LargeDecrement', 'UIA_LinkAttributeId',
    'UIA_MenuOpenedEventId', 'AnnotationType_Highlighted',
    'DockPosition_Right', 'Polite', 'UIA_StylesShapePropertyId',
    'UIA_TableColumnHeadersPropertyId',
    'UIA_OutlineStylesAttributeId', 'UIA_IsOffscreenPropertyId',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_AfterParagraphSpacingAttributeId', 'UIA_TableItemPatternId',
    'UIA_Transform2ZoomLevelPropertyId',
    'IUIAutomationSpreadsheetPattern', 'UIA_VisualEffectsPropertyId',
    'UIA_OutlineThicknessPropertyId', 'IUIAutomation6',
    'IUIAutomationElement7', 'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_SelectionActiveEndAttributeId', 'UIA_IsReadOnlyAttributeId',
    'UIA_LineSpacingAttributeId', 'IUIAutomationElement3',
    'UIA_TransformCanResizePropertyId', 'TreeScope_Ancestors',
    'UIA_FullDescriptionPropertyId', 'TreeScope_Children',
    'ScrollAmount_SmallDecrement', 'UIA_AnnotationAuthorPropertyId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_Invoke_InvokedEventId', 'UIA_GridItemRowSpanPropertyId',
    'UIA_TransformCanMovePropertyId', 'UIA_SemanticZoomControlTypeId',
    'UIA_ItemStatusPropertyId', 'UIA_ScrollItemPatternId',
    'UIA_ProgressBarControlTypeId', 'UIA_FontSizeAttributeId',
    'UIA_DataItemControlTypeId', 'WindowVisualState_Normal',
    'AnnotationType_UnsyncedChange', 'IUIAutomationInvokePattern',
    'UIA_IsControlElementPropertyId',
    'TextPatternRangeEndpoint_Start',
    'NotificationKind_ActionAborted', 'UIA_ProcessIdPropertyId',
    'UIA_FlowsToPropertyId', 'UIA_Selection2ItemCountPropertyId',
    'UIA_IsPasswordPropertyId', 'UIA_AutomationIdPropertyId',
    'UIA_RangeValueLargeChangePropertyId',
    'TextEditChangeType_CompositionFinalized',
    'IUIAutomationObjectModelPattern', 'ZoomUnit_SmallIncrement',
    'UIA_Drag_DragCompleteEventId', 'IUIAutomation2',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'TextEditChangeType', 'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_EditControlTypeId', 'TextUnit_Document', 'HeadingLevel4',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_BulletStyleAttributeId', 'UIA_MarginLeadingAttributeId',
    'UIA_TextControlTypeId', 'CoalesceEventsOptions_Disabled',
    'UIA_WindowControlTypeId', 'IRawElementProviderSimple',
    'UIA_IsTextPatternAvailablePropertyId',
    'CoalesceEventsOptions_Enabled', 'UIA_ListControlTypeId',
    'UIA_SelectionPatternId', 'StructureChangeType_ChildRemoved',
    ...
    'IUIAutomationElementArray', 'IUIAutomationValuePattern',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_TableRowHeadersPropertyId', 'UIA_AnnotationTargetPropertyId',
    'UIA_IsRequiredForFormPropertyId',
    'UIA_SayAsInterpretAsMetadataId', 'UIA_FrameworkIdPropertyId',
    ...
    'StyleId_Heading9', 'UIA_WindowIsModalPropertyId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'ZoomUnit_LargeDecrement', 'UIA_Transform2ZoomMaximumPropertyId',
    'IUIAutomationDockPattern', 'UIA_PaneControlTypeId',
    'StyleId_Heading3', 'UIA_ControlTypePropertyId',
    'AutomationElementMode', 'SynchronizedInputType_LeftMouseDown',
    'UIA_StylesFillPatternStylePropertyId', 'RowOrColumnMajor',
    'DockPosition', 'UIA_HyperlinkControlTypeId',
    'UIA_TreeItemControlTypeId', 'IUIAutomationTextChildPattern',
    'DockPosition_Fill', 'UIA_CulturePropertyId',
    'UIA_FillColorPropertyId', 'HeadingLevel2',
    ...
    'IUIAutomationBoolCondition', 'UIA_AccessKeyPropertyId',
    ...
    'UIA_ValuePatternId', 'IUIAutomation3', 'UIA_TogglePatternId',
    'UIA_DropTarget_DroppedEventId', 'UIA_TableControlTypeId',
    ...
    'UIA_TextEdit_TextChangedEventId', 'StyleId_BulletedList',
    'IUIAutomationTextPattern', 'UIA_TreeControlTypeId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_ThumbControlTypeId', 'UIA_RotationPropertyId',
    'UIA_GridItemRowPropertyId', 'StyleId_Heading6',
    'UIA_DragGrabbedItemsPropertyId', 'SupportedTextSelection_None',
    'TextUnit', 'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_Transform2CanZoomPropertyId', 'IUIAutomationTextEditPattern',
    'UIA_ComboBoxControlTypeId', 'AnnotationType_Endnote',
    'IUIAutomationSpreadsheetItemPattern',
    'WindowVisualState_Minimized', 'ExpandCollapseState_Collapsed',
    'IAccessible', 'UIA_SelectionPattern2Id', 'UIA_MenuClosedEventId',
    'AnnotationType_CircularReferenceError',
    'UIA_RangeValueMaximumPropertyId', 'UIA_StylesStyleIdPropertyId',
    'ZoomUnit_NoAmount', 'LiveSetting', 'IUIAutomation4',
    'UIA_IsSubscriptAttributeId', 'UIA_AnnotationTypesPropertyId',
    'TextUnit_Line', 'SynchronizedInputType',
    ...
    'UIA_Window_WindowClosedEventId', 'IUIAutomationGridItemPattern',
    'TreeTraversalOptions_PostOrder',
    'IUIAutomationEventHandlerGroup', 'AnnotationType_ExternalChange',
    'IUIAutomationElement5', 'AnnotationType_Footnote',
    ...
    'ScrollAmount_NoAmount', 'UIA_Drag_DragCancelEventId',
    'StructureChangeType_ChildAdded', 'AnnotationType_Header',
    'WindowInteractionState_Closing',
    'UIA_AnnotationObjectsPropertyId', 'UIA_TextPatternId',
    'UIA_InputDiscardedEventId', 'UIA_ClickablePointPropertyId',
    'StyleId_Heading8', 'TreeScope_Subtree',
    'UIA_Selection2LastSelectedItemPropertyId', 'DockPosition_Bottom',
    'NotificationKind_Other', 'UIA_ToolBarControlTypeId',
    'UIA_SliderControlTypeId', 'UIA_GridItemColumnPropertyId',
    'NotificationProcessing_ImportantMostRecent',
    'IUIAutomationCustomNavigationPattern',
    'UIA_DropTarget_DragLeaveEventId', 'HeadingLevel3',
    ...
    'ExpandCollapseState_PartiallyExpanded', 'UIA_GridItemPatternId',
    ...
    'UIA_ButtonControlTypeId', 'ToggleState',
    'UIA_HelpTextPropertyId', 'TreeTraversalOptions_LastToFirstOrder',
    'UIA_CaretBidiModeAttributeId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_UnderlineStyleAttributeId', 'UIA_MarginBottomAttributeId',
    'UIA_ControllerForPropertyId', 'IUIAutomationAndCondition',
    ...
    'UIA_IsDialogPropertyId', 'RowOrColumnMajor_Indeterminate',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_ExpandCollapsePatternId', 'NotificationProcessing',
    'IUIAutomation', 'NotificationKind', 'UIA_HeaderControlTypeId',
    'UIA_LiveRegionChangedEventId', 'PropertyConditionFlags_None',
    'UIA_HasKeyboardFocusPropertyId', 'IUIAutomationElement',
    'UIA_ToolTipControlTypeId', 'UIA_MultipleViewPatternId',
    'UIA_WindowCanMaximizePropertyId', 'UIA_ItemContainerPatternId',
    'AnnotationType_DataValidationError',
    'UIA_HeaderItemControlTypeId', 'WindowInteractionState_Running',
    'IUIAutomationCacheRequest', 'OrientationType_Vertical',
    'StyleId_Heading1', 'UIA_IsStylesPatternAvailablePropertyId',
    ...
    'AnnotationType_Footer', 'ProviderOptions_UseComThreading',
    ...
    'IUIAutomationTransformPattern', 'AnnotationType_FormulaError',
    'UIA_DockPatternId', 'UIA_IndentationLeadingAttributeId',
    'UIA_GridItemColumnSpanPropertyId', 'OrientationType',
    'CoalesceEventsOptions',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_ObjectModelPatternId', 'StyleId_Heading5',
    'SynchronizedInputType_RightMouseDown',
    'NavigateDirection_FirstChild', 'UIA_DocumentControlTypeId',
    'NavigateDirection_PreviousSibling',
    'NotificationKind_ItemRemoved', 'UIA_ForegroundColorAttributeId',
    'TextPatternRangeEndpoint_End', 'IUIAutomationPropertyCondition',
    'UIA_RuntimeIdPropertyId', 'UIA_SayAsInterpretAsAttributeId',
    'UIA_MenuControlTypeId', 'UIA_InputReachedTargetEventId',
    'RowOrColumnMajor_RowMajor', 'UIA_StructureChangedEventId',
    'UIA_TabsAttributeId', 'StructureChangeType_ChildrenBulkRemoved',
    ...
    'UIA_LandmarkTypePropertyId', 'ZoomUnit_SmallDecrement',
    'AnnotationType_Unknown',
    'UIA_HorizontalTextAlignmentAttributeId',
    'SynchronizedInputType_RightMouseUp',
    'ProviderOptions_ProviderOwnsSetFocus', 'StyleId_Title',
    'UIA_GridRowCountPropertyId', 'UIA_LegacyIAccessiblePatternId',
    'UIA_Text_TextChangedEventId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_CheckBoxControlTypeId',
    'IUIAutomationVirtualizedItemPattern', 'IUIAutomationElement8',
    'UIA_ToolTipClosedEventId', 'SynchronizedInputType_KeyUp',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_SearchLandmarkTypeId', 'UIA_SummaryChangeId',
    'AnnotationType_DeletionChange',
    'UIA_IsTextPattern2AvailablePropertyId', 'UIA_TablePatternId',
    'UIA_ChangesEventId', 'IUIAutomation5',
    ...
    'UIA_DockDockPositionPropertyId', 'UIA_TabControlTypeId',
    'UIA_SpinnerControlTypeId', 'UIA_ToolTipOpenedEventId',
    'TreeScope_Parent', 'AnnotationType_TrackChanges',
    'UIA_ScrollPatternId', 'UIA_AcceleratorKeyPropertyId',
    'IUIAutomationProxyFactoryEntry', 'IUIAutomationTextRange2',
    'UIA_WindowPatternId', 'ToggleState_Indeterminate',
    'ProviderOptions_ClientSideProvider', 'UIA_StyleNameAttributeId',
    'UIA_WindowIsTopmostPropertyId', 'SynchronizedInputType_KeyDown',
    'UIA_DropTargetPatternId', 'UIA_CapStyleAttributeId',
    'UIA_NotificationEventId', 'UIA_DragDropEffectPropertyId',
    'UIA_HeadingLevelPropertyId', 'UIA_CustomLandmarkTypeId',
    'UIA_IsTablePatternAvailablePropertyId', 'StyleId_Heading7',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_LabeledByPropertyId',
    ...
    'StructureChangeType_ChildrenReordered', 'Off',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_ActiveTextPositionChangedEventId',
    'WindowInteractionState_NotResponding',
    'ScrollAmount_LargeIncrement', 'WindowVisualState_Maximized',
    'UIA_CaretPositionAttributeId', 'IUIAutomationElement6',
    'StyleId_NumberedList', 'TextUnit_Format',
    'UIA_SystemAlertEventId', 'UIA_CalendarControlTypeId',
    'StructureChangeType_ChildrenBulkAdded', 'UIA_TransformPatternId',
    'AnnotationType_Sensitive', 'TextEditChangeType_AutoComplete',
    'UIA_MenuModeEndEventId', 'UIA_DescribedByPropertyId',
    'UIA_AutomationFocusChangedEventId',
    'RowOrColumnMajor_ColumnMajor', 'UIA_CustomControlTypeId',
    'UIA_AppBarControlTypeId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'IUIAutomationDropTargetPattern', 'SupportedTextSelection',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'WindowVisualState', 'DockPosition_Top',
    'UIA_Window_WindowOpenedEventId', 'NavigateDirection_NextSibling',
    'UIA_SelectionSelectionPropertyId', 'ToggleState_Off',
    'UIA_StrikethroughColorAttributeId',
    'UIA_StylesFillColorPropertyId', 'IUIAutomationTogglePattern',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_WindowWindowVisualStatePropertyId',
    'ProviderOptions_UseClientCoordinates', 'TreeTraversalOptions',
    'UIA_IsItalicAttributeId', 'IUIAutomationEventHandler',
    'StyleId_Quote', 'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_DropTarget_DragEnterEventId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'WindowInteractionState', 'IUIAutomationGridPattern',
    'UIA_AnnotationPatternId', 'NotificationProcessing_All',
    'IUIAutomationTreeWalker', 'ExpandCollapseState_Expanded',
    'HeadingLevel_None', 'IUIAutomationTablePattern', 'ScrollAmount',
    'IUIAutomationTextRangeArray', 'NavigateDirection',
    'IUIAutomationNotCondition', 'UIA_MainLandmarkTypeId',
    'StyleId_Heading4', 'DockPosition_None',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'AnnotationType_GrammarError', 'UIA_FontWeightAttributeId',
    'HeadingLevel1', 'StyleId_Heading2', 'UIA_LevelPropertyId',
    'UIA_DataGridControlTypeId',
    'IUIAutomationNotificationEventHandler',
    'IUIAutomationTextRange3', 'UIA_StylesPatternId',
    'UIA_DragPatternId', 'CUIAutomation8',
    'UIA_AnnotationTypesAttributeId', 'AnnotationType_Comment',
    'UIA_ListItemControlTypeId',
    'UIA_Transform2ZoomMinimumPropertyId', 'StyleId_Normal',
    'TextUnit_Word', 'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_TableRowOrColumnMajorPropertyId',
    'IUIAutomationProxyFactory', 'UIA_GridPatternId',
    'IUIAutomationTextPattern2',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_CenterPointPropertyId', 'UIA_NamePropertyId',
    'NotificationProcessing_CurrentThenMostRecent', 'TextUnit_Page',
    ...
    'TextEditChangeType_None', 'IUIAutomationStylesPattern'
]

_check_version('1.1.14', 1655465240.289203)
